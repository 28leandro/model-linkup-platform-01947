...
const translations = {
  pt: {
   ...
   'categories.realEstateSale': '🏠 Imóveis - Venda',
    ...
    'forgotPassword.successDesc': 'Verifique sua caixa de entrada para redefinir sua senha.',
    'forgotPassword.errorTitle': 'Erro ao enviar email',
  ...
  es: {
   ...
   'categories.realEstateSale': '🏠 Inmuebles - Venta',
    ...
    'forgotPassword.successTitle': '¡Email enviado!',
    'forgotPassword.successDesc': 'Revisa tu bandeja de entrada para restablecer tu contraseña.',
    'forgotPassword.errorTitle': 'Error al enviar email',
