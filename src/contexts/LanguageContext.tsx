...
const translations = {
  pt: {
   ...
   'categories.realEstateSale': '🏠 Imóveis - Venda',
    ...
    'categories.realEstate': '🏠 Imóveis',
    'categories.realEstate.desc': 'Venda e aluguel de casas, apartamentos e terrenos',
    ...
    'postAd.fuelDiesel': 'Diesel',
    'postAd.fuelElectric': 'Elétrico',
  ...
  es: {
   ...
   'categories.realEstateSale': '🏠 Inmuebles - Venta',
    ...
    'categories.realEstate': '🏠 Inmuebles',
    'categories.realEstate.desc': 'Venta y alquiler de casas, departamentos y terrenos',
