...
const RecentListings = ({ listings, initialLimit = 8, expandMode = "inline" }: RecentListingsProps) => {
  ...
  const renderCard = (listing: Listing) => (
    <div key={listing.id} className="group relative bg-transparent rounded-xl overflow-hidden shrink-0 w-[44%] sm:w-[38%] md:w-[30%] snap-start lg:w-[360px] lg:h-[240px] lg:flex-shrink-0 flex flex-col">
      <div className="rounded-xl overflow-hidden lg:h-[120px] lg:flex-shrink-0">
